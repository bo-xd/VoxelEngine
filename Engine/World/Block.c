...
vec3 BlockTypeToColor(block_type type) {
    vec3 baseColor;
    switch(type) {
        case BLOCK_GRASS: baseColor = (vec3){0.0f, 1.0f, 0.0f}; break;
        case BLOCK_STONE: baseColor = (vec3){0.5f, 0.5f, 0.5f}; break;
        case BLOCK_WOOD:  baseColor = (vec3){0.55f, 0.27f, 0.07f}; break;
